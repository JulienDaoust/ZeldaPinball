...
: NoeudComposite{ typeNoeud }
{
	...
	modele_.charger("media/table.obj");
...
BoiteEnglobante NoeudPlaque::obtenirBoiteEnglobante()
{
	...
	boitePositionnee.coinHG = { translation[0] + boitePositionnee.coinHG[0] + 6, translation[1] + boitePositionnee.coinHG[1] - 10, 0 };
	boitePositionnee.coinBG = { translation[0] + boitePositionnee.coinBG[0] + 6, translation[1] + boitePositionnee.coinBG[1] + 10, 0 };
	boitePositionnee.coinHD = { translation[0] + boitePositionnee.coinHD[0] - 6, translation[1] + boitePositionnee.coinHD[1] - 10, 0 };
	boitePositionnee.coinBD = { translation[0] + boitePositionnee.coinBD[0] - 6, translation[1] + boitePositionnee.coinBD[1] + 10, 0 };
