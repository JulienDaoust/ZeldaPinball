...
namespace vue {
	...
	public:
		...
		void zoomerOut(const glm::dvec3& coin1, const glm::dvec3& coin2);
		/// Zoom in élatique, sur un rectangle.
		void zoomerIn(const glm::dvec3& coin1, const glm::dvec3& coin2);
		...
		void translater(const glm::dvec2& deplacement);
	...
	private:
		...
		/// point centre
		glm::dvec2 centre_ = glm::dvec2(0, 0);
