...
void NoeudPaletteJoueur1::afficherConcret() const
{
	...
	if (estSelectionne())
	{
		...
		glVertex3f(boiteEnglobante.coinBD[0], boiteEnglobante.coinBD[2], boiteEnglobante.coinBD[1]);
		glVertex3f(boiteEnglobante.coinHD[0], boiteEnglobante.coinHD[2], boiteEnglobante.coinHD[1]);
		glVertex3f(boiteEnglobante.coinHG[0], boiteEnglobante.coinHG[2], boiteEnglobante.coinHG[1]);
		glVertex3f(boiteEnglobante.coinBG[0], boiteEnglobante.coinBG[2], boiteEnglobante.coinBG[1]);
		glEnd();
