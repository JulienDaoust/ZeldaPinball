...
Ce fichier contient la déclaration de l'espace de nom aidecollision.  
...
Ce fichier contient la déclaration de l'espace de nom aidecollision. Il contient les déclarations de fonctions utiles pour le calcul des forces causées par les collisions.
