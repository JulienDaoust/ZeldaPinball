...
Ce fichier contient l'implantation de l'espace de nom aidegl. Il contient les déclarations de fonctions utiles pour effectuer certaines tâches Open\-G\-L qui reviennent d'un projet à l'autre.
