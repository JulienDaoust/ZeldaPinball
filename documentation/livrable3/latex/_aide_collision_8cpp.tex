...
Ce fichier contient l'implantation de l'espace de nom aidecollision. Il contient les implantations de fonctions utiles pour le calcul des forces causées par les collisions.
