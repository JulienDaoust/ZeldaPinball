...
À noter que seuls les variables définies dans la version 1.\-1 de Open\-G\-L sont lues par cette classe. Il faudrait éventuellement dériver d'autres classes de celle-\/ci afin d'ajouter les fonctionnalités des versions plus récentes d'Open\-G\-L.
